...
[![Build status](https://ci.appveyor.com/api/projects/status/abd1xcpidf0gyo59?svg=true)](https://ci.appveyor.com/project/Dimafdr/chat-frontend)
...
## 8.1 Чат (Frontend, [Backend](https://github.com/Dimafdr/Chat-Backend))
